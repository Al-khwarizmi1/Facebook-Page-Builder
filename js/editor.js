...
var documentBasePath = documentBasePath.substring(0, documentBasePath.indexOf('?'));
var documentBasePath = documentBasePath.substring(0, documentBasePath.indexOf('index.php'));
var divB ;
...
var nicEditorConfig = bkClass.extend({
    ...
    iconsPath : documentBasePath+'components/com_fbpagebuilder/images/nicEditIcons-latest.gif',
...
var nicColorOptions = {
    buttons : {
        ...
        'bgcolor' : {
            name : __('Change Hilite Background Color'),
            type : 'nicEditorBgColorButton',
            noClose : true
        },
        'backgroundcolor' : {
            name : __('Change Background Color'),
            type : 'nicEditorBackColorButton',
            noClose : true
        }
    }
};
...
var nicEditorBackColorButton=nicEditorColorButton.extend({
    colorSelect:function(A){
        document.getElementById(divB).style.background = A;
        this.ne.nicCommand("backgroundcolor",A);
        this.removePane()
    }
});
