...
/**
 * FBpagebuilder Page form View
 */
class fbpagebuilderViewpage extends JView {

    /**
     * display method of page view
     * @return void
     */
    public function display($tpl = null) {
        ...
        if ($isLogged == '') {
            ...
            if($page=='republish'){
             $msg = JText::_('The page is published successfully. You can modify the page content and republish the page.');
            $mainframe = JFactory::getApplication();
            $mainframe->redirect(JRoute::_('index.php?option=com_fbpagebuilder&view=page&layout=edit&id='.$id, false), $msg);
            ...
            parent::display($tpl);
            fbpagebuilderHelper::addSubmenu(JRequest::getCmd('view', 'page'));
        }
    }
    ...
    protected function addToolBar() {
        ...
        JToolBarHelper::title($isNew ? JText::_('COM_FBPAGEBUILDER_PAGES_NEW') : JText::_('COM_FBPAGEBUILDER_PAGES_EDIT'));
