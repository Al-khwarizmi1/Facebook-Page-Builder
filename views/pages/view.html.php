 ...
 * Pages View
 */
class fbpagebuilderViewpages extends JView {
    ...
    function display($tpl = null) {
        ...
        if ($isLogged == '') {
            ...
            parent::display($tpl);
            fbpagebuilderHelper::addSubmenu(JRequest::getCmd('view', 'pages'));
        }
    }
    ...
    protected function addToolBar() {
        ...
        $apiId = $fbApi->license;
        JToolBarHelper::title(JText::_('COM_FBPAGEBUILDER_MANAGE_PAGES'));
        JToolBarHelper::editListX('page.edit');
        JToolBarHelper::deleteListX('', 'pages.delete');
