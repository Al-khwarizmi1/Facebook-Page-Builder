...
/**
 * FBpagebuilder contacts list Controller
 */
class fbpagebuilderControllersettings extends JControllerAdmin {

    /**
     * Proxy for getModel.
     * @since       1.6
     */
    public function getModel($name = 'setting', $prefix = 'fbpagebuilderModel') {
